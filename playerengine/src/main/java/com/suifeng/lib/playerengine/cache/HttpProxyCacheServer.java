...
import com.suifeng.lib.playerengine.cache.file.Md5FileNameGenerator;
import com.suifeng.lib.playerengine.cache.file.TotalCountLruDiskUsage;
import com.suifeng.lib.playerengine.cache.file.TotalSizeLruDiskUsage;
import com.suifeng.lib.playerengine.cache.headers.EmptyHeadersInjector;
...
import com.suifeng.lib.playerengine.cache.sourcestorage.SourceInfoStorageFactory;
...
import static com.suifeng.lib.playerengine.cache.Preconditions.checkAllNotNull;
import static com.suifeng.lib.playerengine.cache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            Log.e(TAG,"Error touching file " + cacheFile, e);
        }
    }
